...
<Box p={4} color="white" bg="primary">
  Geks World NFT Club is a collection of 10,000 Iconic Gekyume Artworks, which provides
...
<Box p={4} color="white" bg="primary">
  ...
  at music events, exclusive access to podcasts, episodes and release parties.
</Box>
